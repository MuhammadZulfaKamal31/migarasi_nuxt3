<template>
    <div class=" bg-slate-200">
        <div class=" flex flex-col items-center md:items-start lg:pt-16 pt-1
        md:flex-row h-screen lg:h-[580px] gap-5 md:ml-[40px] md:px-5 px-10 py-20 md:py-4"
            :class="sideBar.openSideBar ? 'md:pr-[250px] duration-300' : 'md:px-[4%] duration-300'">
            <!-- //pageName -->
            ...
            <div v-else class="flex lg:flex-row  flex-col gap-5 w-full">
                ...
                <div v-show="loading == false" class="py-[30px] md:py-0 w-full md:w-0 mt-14 md:mt-0">
                    <div class="h-10 bg-white rounded-md flex items-center justify-between px-2 md:invisible ">
                        <span class=" text-[15px] md:text-2xl font-[500]"> Dashboard</span>
                        <div
        ...
        <div class=" w-full bg-slate-200 text-start p-5 pl-[65px] shadow-sm -mt-16 lg:mt-0">
