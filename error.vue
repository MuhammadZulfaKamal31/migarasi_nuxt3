<template>
    <!-- component -->
    <div class="w-full h-screen flex flex-col lg:flex-row justify-between">
        <div class="w-full flex flex-col items-end md:items-center justify-center lg:px-2 xl:px-0 text-center">
            ...
            <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">Sorry, the page you are looking for could not
                ...
                found.</p>
            <NuxtLink to="/">
                <div class=" bg-red-500 border p-2 px-3 rounded-md mt-4">
                    Return Home
                </div>
            </NuxtLink>
        </div>
        <div class=" flex items-center lg:items-end justify-center px-12">
            <svg class="w-full" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1120.59226 777.91584"
